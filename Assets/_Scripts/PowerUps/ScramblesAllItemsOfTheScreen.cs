...
{
    [CreateAssetMenu(menuName = "Game/PowerUps/ScramblesAllItemsOfTheScreen", fileName = "ScramblesAllItemsOfTheScreen")]
    public class ScramblesAllItemsOfTheScreen : ScriptableObject
    {
